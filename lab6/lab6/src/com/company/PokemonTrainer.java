...
public class PokemonTrainer extends JFrame{
    ...
    public void createSceneGraph(SimpleUniverse su){
        ...
        TextureLoader t = new TextureLoader("source_folder//forest.png", myCanvas3D);
        ...
        setToMyDefaultAppearance(bodyApp, new Color3f(0.5f, 0.5f, 0.2f));
        ...
        setToMyDefaultAppearance(ballApp, new Color3f(0.0f, 0.9f, 0.0f));
        ...
        setToMyDefaultAppearance(secondBallApp, new Color3f(0.9f, 0.0f, 0.0f));
        ...
        setToMyDefaultAppearance(headApp, new Color3f(0.3f, 0.3f, 0.9f));
        ...
        setToMyDefaultAppearance(faceApp, new Color3f(0.9f, 0.9f, 0.7f));
        ...
        setToMyDefaultAppearance(bagApp, new Color3f(0.9f, 0.3f, 0.4f));
